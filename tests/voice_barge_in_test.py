 ...
 def test_real_vad_double_bargein_and_shutdown(self):
  ...
  try:
   ...
   with sync_playwright() as p:
    ...
    self.assertTrue(page.evaluate('constraints.audio.echoCancellation'))
    ...
    self.assertEqual(page.evaluate('fakeDest.stream.getTracks()[0].readyState'),'live')
    perf=page.evaluate('({roundTripMs:vadTimes,maxPending})')
    ...
    page.locator('#jarvis-chat-input').fill('401 fixture');page.locator('#jarvis-chat-input').press('Enter');page.wait_for_url('**/login.html')
